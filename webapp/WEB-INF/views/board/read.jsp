				...
				<div id="board">
					<div id="read">
						<%-- <form action="${ pageContext.request.contextPath }/board/modifyForm" method="post"> --%>
							...
							<c:if test="${ sessionScope.authUser.no eq getBoard.userNo }">
								<a id="btn_modify" href="${ pageContext.request.contextPath }/board/modifyForm?no=${ requestScope.getBoard.no }">수정</a>
							</c:if>
