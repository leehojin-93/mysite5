					...
					<div id="modifyForm">
						<form action="${ pageContext.request.contextPath }/user/modify" method="post">
							...
							<div class="form-group">
								...
								<input type="password" id="input-pass" name="password" value="${ requestScope.authUserInfo.password }">
							</div>
	
							<!-- 이름 -->
							<div class="form-group">
								<label class="form-text" for="input-name">이름</label> 
								<input type="text" id="input-name" name="name" value="${ requestScope.authUserInfo.name }">
							</div>
							...
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${ 'male' eq requestScope.authUserInfo.gender }">
